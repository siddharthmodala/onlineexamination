		...
		try{
			...
			while(read.hasMoreTokens())
			{
				...
				if(token.countTokens()==2)
				{
					...
					ResultSet rs=db1.executeDBQuery("select stdname from  student where stdno='"+id+"'");
					if(rs.next())
					{
						String str1="insert into "+table+" values ('"+id+"','"+rs.getString(1)+"',"+code+",null)";
						db.executeDBUpdate(str1);
					}	
				}
				else
			...
			<br/><br/><br/>To view the Marks of Students <a href="displaycode.jsp">Click Here</a></h4> 
			<%
		}
